...
contract Market {
    ...
    Order[] public orders;
    mapping (uint256 => uint256) public idToOrderIndex;//token id to index in order
    ...
    function buy(uint256 _tokenId) external{
        ...
        require(erc20.transferFrom(buyer,seller,price),"transfer not success");
    ...
    function isLisited(uint256 _tokenId) public view returns(bool){
